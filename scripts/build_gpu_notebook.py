...
cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            "from cir_arc.neural.models.cir_arc_3b import CirArc3B, CirArc3BConfig\n",
            "\n",
            "# 1. Instantiate 3.000B Parameter Model directly on CUDA device\n",
            ...
            "print('      [SUCCESS] 3.000B model loaded into GPU VRAM (6.0 GB footprint)!', flush=True)\n",
            "\n",
            "# 2. High-Throughput DataLoader\n",
            "batch_size = 2\n",
